...
$_PMBP_GLOBAL_CONF="xfig/global_conf.php";       // example: $_PMBP_GLOBAL_CONF="../../files/global_conf.php";
$_PMBP_EXPORT_DIR="xfig/export/";                // example: $_PMBP_EXPORT_DIR="../../files/export/";
