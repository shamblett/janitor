...
<table width=\"".$tabe_width."\">
 <tr>
  <th class=\"active\">\n";
   echo "Tailored for the MODx Revolution Janitor 3PC by S. Hamblett 2010 <steve.hamblett@linux.com></steve.hamblett>";
   echo "\n</th>\n </tr>\n";
...
function PMBP_email_store($attachments,$backup_info) {
    ...
    foreach($all_emails as $email) {
        // verify email
        if (!preg_match("#^\ *[������a-zA-Z0-9_-]+(\.[������a-zA-Z0-9\._-]+)*@([������a-zA-Z0-9-]+\.)+([a-z]{2,4})$#",$email)) {
